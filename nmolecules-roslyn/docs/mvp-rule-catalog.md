...
- bounded-context metadata and dependency-boundary consistency through `XMoleculesBoundedContext0011`
...
- bounded-context dependency semantics beyond the current canonical target baseline (`XMoleculesBoundedContext0012+`)
