...
using NMolecules.DDD.Analyzers.EntityAnalyzers;
using NMolecules.DDD.Analyzers.Test.EntityAnalyzerTests.SampleData;
using Xunit;
using static Microsoft.CodeAnalysis.Testing.DiagnosticResult;
using static NMolecules.DDD.Analyzers.Test.ElementNames;
using VerifyCS = NMolecules.DDD.Analyzers.Test.Verifiers.CSharpAnalyzerVerifier<NMolecules.DDD.Analyzers.EntityAnalyzers.EntityAnalyzer>;

namespace NMolecules.DDD.Analyzers.Test.EntityAnalyzerTests
{
